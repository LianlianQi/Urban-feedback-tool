PREDEFINED_PERSONAS = {
    "Local Resident": {
        ...
        "other_values": ["Nostalgia and emotional attachment to the park", "Enjoys safe, family-friendly environments"],
    ...
    "Parent with Stroller": {
        ...
        "other_values": ["Community connections", "Child safety", "Convenient, family-oriented design"],
    ...
    "Senior Citizen": {
        ...
        "other_values": ["Community history preservation", "Intergenerational connection", "Peaceful, quiet spaces"],
    ...
    "Young Professional": {
        ...
        "other_values": ["Environmental sustainability", "Night safety", "Reliability"],
    ...
    "Immigrant": {
        ...
        "other_values": ["Cultural tradition", "Community gathering", "Affordability"],
    ...
    "Student Commuter": {
        ...
        "other_values": ["affordability", "flexibility and informal gathering spaces"],
...
PERSONA_CATEGORIES = {
    ...
    "Other values": "What matters most to them"
}
